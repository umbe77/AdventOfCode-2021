...
import { parseInput, countSimpleDigits, getAllSignalMappings } from '../src/day-08.js'
...
describe("Advent Day 08", () => {

	it("Count simple digits", () => {
		const data = parseInput(input)
		const count = countSimpleDigits(data)
